...
- There exists a negative correlation between percentage of internet users and family income. Since the coefficient of determination is small, the linear model is a poor fit and the data is not linear. 
